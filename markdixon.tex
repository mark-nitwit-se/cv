...
\begin{rSection}{OBJECTIVE}
  ...
  From real-time physics engines to climate transition platforms, I've
  spent 25+ years turning complex technical systems into practical
  software, most recently as CTO and CSO of ClimateView. My focus now
  is on AI agents: as Senior AI Agent Platform Developer at Abundly
  AI, I'm part of the team helping build our TypeScript/React/MongoDB
  agent platform, and help design, evaluate and tune the agents that
  run on it.

  Looking to go deeper into agentic AI systems --- architecture,
  evaluation and reliability --- alongside a team building at the frontier.
...
\\*
Code & {\bf Python}, {\bf TypeScript}, C/C++, Julia, C\#
\\*
Tech & React, MongoDB, Unix (Linux/BSD/IRIX), Windows, Django, Wagtail, LaTeX, Claude Code
\\*
...
\begin{rSection}{EXPERIENCE}
  ...
  {\rExperience
      {Senior AI Agent Platform Developer} {Abundly AI AB} {Feb 2026 - present}
      {
        Part of the team helping build Abundly's AI agent platform (agent-web / agent-service): TypeScript/React front-end, MongoDB-backed services, and MCP tool integrations. Also help design, evaluate and trim Abundly's internal agents --- prompt engineering, evals/benchmarking and cost/latency tuning.
      }
      {TypeScript · React · MongoDB · Model Context Protocol (MCP) \\*
        LLM Agents · Prompt Engineering · Evals · Cost \& Latency Tuning}
  }

  \PRLsep

  {\rExperience
      {Chief Science Officer} {ClimateView AB} {May 2024 - Jan 2026}
      {
        Worked initially as advisor / staff engineer during CTO hand-over period. Subsequently CSO responsible for research, prototyping, modelling and over-all scientific rigour of ClimateView and the Transition Element Framework (\href{https://transitionelements.org}{https://transitionelements.org} and \href{https://github.com/nitwit-se/transition-element-framework}{https://github.com/nitwit-se/transition-element-framework}).
      }
  ...
  {\rExperience
    {CTO} {ClimateView AB} {2018 - 2024}
    {As a hands-on fractional CTO I took ClimateView AB from a 3-person startup to successful series-A round and subsequent recruitment of a full-time CTO.}
  ...
  {\rExperience
    {Python Developer / Agile Coach} {Motivation Media Group AB} {2017 - 2022}
    {Consultant developer and agile coach for Motivation Media Group AB and its subsidiary NextLVL Stockholm AB. Developed the new \href{https://motivation.se}{Motivation.se 2.0} platform (Wagtail, rewrite of the original PHP platform) and a modern Learning Management System (LMS) in Python/Django.}
    {Agile Methodologies · Python · Wagtail · Django · DevOps · AWS · EC2 / Elastic Beanstalk}
  }
